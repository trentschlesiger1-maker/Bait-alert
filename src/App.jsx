...
const DISCLAIMER = "This app provides general risk guidance only based on publicly available information about 1080 baiting programs in Australia. " + "It does NOT provide real-time data and should NOT be relied upon as a definitive safety guide. " + "Always check with local councils and national parks for current baiting programs. " + "Keep pets on leads in all rural areas. " + "Emergency: Animal Poisons Helpline 1300 869 738.";
